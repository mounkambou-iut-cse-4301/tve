...
<div class="container mt-3">
    ...
    @include('layouts/partials/_teachersidebar')
        <div class="col-lg-6">
            ...
            <div class="card"  style="margin-bottom: 1%;">
                <div class="card-body">
                    <form action="/teacher_post/{{$message->message_id}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
        ...
        <div class="col-lg-3">
            ...
            @foreach($other_message as $other_message)
                ...
                <a href="/teacher_post/{{$other_message->message_id}}" class="link_studentsidebar">{{$other_message->title}},({{$other_message->course_fk_message}})</a>
                </div>
                @endforeach
            </div>
        </div>
